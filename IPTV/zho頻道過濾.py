...
#  获取远程港澳台直播源文件
url = "https://live.hacks.tools/iptv/languages/zho.m3u"          #源采集地址
r = requests.get(url)
open('zho.m3u','wb').write(r.content)         #打开源文件并临时写入
...
if __name__ == "__main__":
    source_file_path = 'IPTV/zho.m3u'  # 替换为你的源文件路径
    output_file_path = 'zho'  # 替换为你的输出文件路径,不要后缀名
